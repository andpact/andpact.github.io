...
## **Lifecycle**
- 객체의 생성과 소멸 자체를 의미하거나, Bean이나 IoC Container의 생성과 소멸을 통제하는 메서드를 사용하기 위해 구현하는 인터페이스

## **LifecycleProcessor**
- IoC Container 내의 Bean의 생성과 소멸을 위한 메서드를 제공하는 인터페이스
...
## **BeanPostProcessor**
- Bean이 생성될 때 호출되는 Callback 메서드를 정의하기 위하여 구현하는 인터페이스
